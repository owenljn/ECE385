...
module LCD_Display(iCLK_50MHZ, iRST_N, history1, history2, history3, history4,
...
module LCD_display_string(index,out, history1, history2, history3, history4);
	input [4:0] index;
	input [7:0] history1, history2, history3, history4;
	output reg [7:0] out;
//	always
//		case (history)
//	9'b000000001: hexValue <= 8'h41; 
//	9'b000000010: hexValue <= 8'h42; 
//	9'b000000100: hexValue <= 8'h43; 
//	9'b000001000: hexValue <= 8'h44; 
//	9'b000010000: hexValue <= 8'h45; 
//	9'b000100000: hexValue <= 8'h46; 
//	9'b001000000: hexValue <= 8'h47; 
//	9'b010000000: hexValue <= 8'h48; 
//	9'b100000000: hexValue <= 8'h49;
//	default: hexValue <= 8'h20;
//		endcase
