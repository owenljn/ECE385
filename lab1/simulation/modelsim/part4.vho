...
SIGNAL \ALT_INV_SW~combout\ : std_logic_vector(2 DOWNTO 2);
...
\ALT_INV_SW~combout\(2) <= NOT \SW~combout\(2);
...
-- Equation(s):
-- \HEX0~0_combout\ = (\SW~combout\(0) & !\SW~combout\(2))
...
-- Equation(s):
-- \HEX0~1_combout\ = (!\SW~combout\(2) & ((\SW~combout\(0)) # (\SW~combout\(1))))
...
-- Equation(s):
-- \HEX0~2_combout\ = (\SW~combout\(1)) # (\SW~combout\(2))
